          ...
          <div class="grid lg:grid-cols-3 md:grid-cols-2 items-start md:mt-[0] mt-[40px]">
            ...
            <div>
              <div class="md:text-[18px] text-[16px] md:mb-[0] mb-[32px] leading-[-1px]">
                ...
                <p class="text-[#232323] font-[500]">(734) 287-6619</p>
              </div>
              <div class="mt-[10px] md:text-[18px] text-[16px] leading-[-1px]">
                <p class="text-[#626262] mb-[4px]">Email</p>
                <a class="text-[#232323] font-[500]" href:mailto="info@agencyai.com"
                  >info@agencyai.com</a
                >
              </div>
            </div>
            ...
            <div class="lg:mt-[0] md:mt-[40px] mt-[40px] flex items-center space-x-[26px]">
              ...
              <img src="/icons/teenyicons_instagram-solid_blue.svg" alt="instagram" />
